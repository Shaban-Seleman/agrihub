...
public class DemandListing {
    ...
    @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "crop_id", nullable = false) private Crop crop;
    ...
    @Column(precision = 12, scale = 2) private BigDecimal offeredPricePerUnit;
